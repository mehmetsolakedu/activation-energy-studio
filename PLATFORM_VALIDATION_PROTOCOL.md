...
Before the manual upload/export path, click **Bilimsel öz sınamayı çalıştır**.
...
Bu değer tam-hassasiyetli ham sonuçların doğrudan JSON hash'i değildir. Ham
sonuçlar kayıtta aynen tutulur; hash sözleşmesi Ea'yı 6, R²'yi 12, α ve eşikleri
6 ondalık basamaklı dizgelere dönüştürür, kategorik alanları ve dizi sırasını
aynen korur. Bu sürümlü kanonikleştirme, Chrome 150 ile Node/jsdom arasında
ölçülen en büyük `1.4211e-13 kJ/mol` son-bit farkını bilimsel içeriği
gevşetmeden ortadan kaldırır.
The locked v0.2.0 scientific-build fingerprint is
`38a8d33c1d1d90e361078ae98bb4721dee6442e16453166df4219bc69f29d0a7`.
Download **Platform kanıt JSON'u** before closing the page. The JSON records the
