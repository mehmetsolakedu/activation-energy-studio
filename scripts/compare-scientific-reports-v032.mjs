...
// Version-specific comparator accepting the v0.3.2 project-report schema.
...
function main(paths) {
  if (paths.length < 2) {
    throw new Error(
      'Usage: node scripts/compare-scientific-reports-v032.mjs <report-a.json> <report-b.json> [report-c.json ...]',
    );
  }
