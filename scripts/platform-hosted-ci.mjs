...
export function validateExpectedDownloadSet(downloads) {
  ...
  if (selfTestName !== 'activation-energy-platform-self-test-v0.2.0-pass.json') {
    fail('DOWNLOAD_NAME_INVALID', 'The retained self-test download must be the exact v0.2.0 PASS JSON.');
  }
